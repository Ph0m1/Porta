...
func TestRandomLB_noEndpoints(t *testing.T) {
	subscriber := FixedSubscriber{}
	balancer := NewRandomLB(subscriber, 34567)
...
func (s erroredSubscriber) Hosts() ([]string, error) {
	return []string{}, errors.New(string(s))
}

func TestRoundRobinLB_erroredSubsciber(t *testing.T) {
	want := "supu"
